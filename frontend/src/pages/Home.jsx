            ...
            <Link to="/register">
              ...
              >
                Regístrate
                                                                                    ...
                                                                                    {/* Seccion de tiendas */}
      <section style={{ padding: "64px 16px", backgroundColor: "#FFFFFF", textAlign: "center" }}>
        <span
          style={{
        ...
        <h2 style={{ fontSize: "32px", color: "#000000", fontWeight: "bold", marginBottom: "8px" }}>
          Negocios cerca tuyo
        </h2>
        <p style={{ color: "#000000", marginBottom: "48px" }}>
          Descubre los comercios que están a tu alrededor y aprovecha sus ofertas.
        </p>
        ...
        >
          ...
          >
            ...
            <div style={{ padding: "16px", textAlign: "left" }}>
              <h3 style={{ fontSize: "18px", fontWeight: "bold", color: "#000000" }}>El Desafío</h3>
              <p style={{ color: "#fbbf24", fontSize: "14px", marginBottom: "8px" }}>⭐⭐⭐⭐☆ 4.8</p>
              <p style={{ color: "#666666", fontSize: "14px", marginBottom: "16px" }}>
                Un restaurante ideal para disfrutar de buena comida con amigos y familia.
              </p>
