...
import profile from "../img/profile.png";                                           {/* Logo de perfil */}
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
        <Link to="/">
          <img src={logo} alt="SaborUY" style={{ width: "32px", height: "32px" }} />
        </Link>
        <ul
          style={{
            display: "flex",
        ...
        >
          ...
          <li><Link to="/about" style={{ color: "#fff", textDecoration: "none" }}>Sobre Nosotros</Link></li>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
        <span style={{ fontSize: "14px", color: "#fff" }}>Bienvenido, Invitado</span>
        <Link to="/profile">
          <img
            src={profile}
            alt="profile"
